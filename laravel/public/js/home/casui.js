...
(function(factory) {
	...
	var Dialog = function(options) {
		...
		var dialogTpl = '<div class="global_dialog_confirm_main" style="width:{width}px; display: block;">' +
			...
			btns +
			'</div>' +
			'<div class="global_black_overlay"></div>';
	...
	var DropList = function(options, obj) {
		...
		this.selectHtml = '<input type="hidden">' +
			'<b class="dptick r"></b>' +
			'<span></span>' +
			'<ul class="dpmenu" style="display: none;"></ul>';

        ...
        <div class="am-panel am-panel-default">
          ...
          <div id="collapse-panel-2" class="am-in">
            <table class="am-table am-table-bd am-table-bdrs am-table-striped am-table-hover">
              ...
              <tr>
                <td class="am-text-center"><img src="{{url('/images/admin/admin-chrome.png')}}" alt=""></td>
                <td>Google Chrome</td>
                <td>3,005</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="{{url('/images/admin/admin-firefox.png')}}" alt=""></td>
                <td>Mozilla Firefox</td>
                <td>2,505</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="{{url('/images/admin/admin-ie.png')}}" alt=""></td>
                <td>Internet Explorer</td>
                <td>1,405</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="{{url('/images/admin/admin-opera.png')}}" alt=""></td>
                <td>Opera</td>
                <td>4,005</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="{{url('/images/admin/admin-safari.png')}}" alt=""></td>
                <td>Safari</td>
                <td>505</td>
              </tr>
              </tbody>
        ...
        <div class="am-panel am-panel-default">
          ...
          <div class="am-panel-bd am-collapse am-in am-cf" id="collapse-panel-3">
            <ul class="am-comments-list admin-content-comment">
              <li class="am-comment">
                <a href="#"><img src="{{url('/images/admin/bw-2014-06-19.jpg')}}" alt="" class="am-comment-avatar" width="48" height="48"></a>

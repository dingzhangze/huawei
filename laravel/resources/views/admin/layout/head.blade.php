      ...
      <ul class="am-list admin-sidebar-list">
		...
		<li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub " id="collapse-nav">
            <li><a href="{{url('/Admin/user')}}" class="am-cf"><span class="am-icon-th"></span> 用户列表</a></li>

            <li><a href="{{ url("/Admin/user/create") }}"><span class="am-icon-puzzle-piece"></span> 添加用户</a></li>
            <li><a href="{{url('/Admin/group')}}"><span class="am-icon-th"></span> 分组列表<span class="am-badge am-badge-secondary am-margin-right am-fr"></span></a></li>
            <li><a href="{{url('/Admin/group/create')}}"><span class="am-icon-puzzle-piece"></span> 添加分组</a></li>
           <li><a href="{{ url("/Admin/rule") }}"><span class="am-icon-th"></span>权限列表</a></li>
             <li><a href="{{url('/Admin/rule/create')}}"><span class="am-icon-puzzle-piece"></span>添加权限</a></li>
		...
		<li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub " id="collapse-nav1">
            <li><a href="" class="am-cf"><span class="am-icon-th"></span> 分类列表</a></li>
            <li><a href=""><span class="am-icon-puzzle-piece"></span> 添加根类</a></li>     
          </ul>
        </li>
		<li class="admin-parent">
		...
		<li class="admin-parent">
          <a class="am-cf" data-am-collapse="{target: '#collapse-nav2'}"><span class="am-icon-file"></span> 广告管理 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
          <ul class="am-list am-collapse admin-sidebar-sub " id="collapse-nav2">
